  ...
  return (
    <TooltipProvider>
      <div className="flex h-screen bg-background">
        {/* Sidebar */}
        <aside className={`${collapsed ? 'w-16' : 'w-60'} flex flex-col border-r border-border bg-[#09090b] transition-all duration-300`}>
          {/* Logo area */}
          <div className="h-16 flex items-center justify-between px-4 border-b border-border">
            {!collapsed && (
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading font-bold text-lg text-foreground">EasyMoney</span>
              </div>
            )}
            <Button 
              variant="ghost" 
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button 
                    ...
                    onClick={lockApp}
                    className="flex-1 text-muted-foreground hover:text-amber-500"
